    ...
    <tr >
     ...
     <tr>
      <td style="color: black; font-family: 'open sans', sans-serif; font-weight: 300; font-size: 32px; padding:96px 32px 0px 32px;">
         Welcome To Cruise-Crew-IQ<br><br>
      <b style="color:#D50057; font-weight: 700; font-size: 24px">${name},</b><br>
      <span style="font-size: 18px; font-weight: 400; line-height: 18px;">We're so excited to officially welcome you to Cruise-Crew-IQ! We can’t wait to start this amazing journey together and see all the great things we’ll accomplish. Kindly click the button below to set your password and start selling on the platform.<br></span><br>
      </td>
     </tr>
     <tr>
      <td style=" padding:0px 32px 0px 32px;">
         <a href="${setPasswordLink}" style="background-color: #D50057; border-radius: 32px;  color: #ffffff;  font-size: 14px; font-family: 'open sans', sans-serif; font-weight: 600; padding: 16px 48px; text-decoration: none;">Set Password</a> 
      </td>
     </tr>
     <tr>
      <td style="color: black; font-family: 'open sans', sans-serif; font-weight: 300; font-size: 32px; padding:64px 32px 0px 32px;">
        <span style="font-size: 18px; color:#8C9091; line-height: 14px;">If you face challenges setting your password please contact the admin.<br><br></span><br>
      </td>
       </tr>
    </table>
     </td>
